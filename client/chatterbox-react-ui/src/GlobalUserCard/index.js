...
export default class GlobalUserCard extends Component {
  constructor(props) {
    ...
    var { user_id, name, created_at, following } = this.props.person;
    this.name = name;
  ...
  handleFollow = (event) => {
    ...
    fetch(`http://localhost:8080/svc/follow?follow_id=${this.user_id}`, {
      method: "GET",
      mode: "cors",
      headers: myHeaders,
    })
  ...
  handleUnFollow = (event) => {
    ...
    fetch(`http://localhost:8080/svc/unfollow?follow_id=${this.user_id}`, {
      method: "GET",
      mode: "cors",
      headers: myHeaders,
    })
